...
func update_button_theme():
	...
	style_pressed.bg_color = selected_cell_color
...
#	style_focus.bg_color = selected_cell_color
...
#	style_focus.border_width_bottom = outline_width
	...
	# Apply the font to the custom theme
	custom_theme.set_font("font", "Button", Global.font)
